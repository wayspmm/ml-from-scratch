...
Качество модели отличается от LightGBM на 0.7–1.5 процентных пункта по ROC-AUC. Основная оставшаяся разница обусловлена использованием в LightGBM поиска разбиений по гистограммам и роста деревьев по листьям (leaf-wise growth), что не входит в задачи данного проекта.
